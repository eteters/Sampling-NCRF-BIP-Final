...
def getTissueMask(wsi_path, level, RGB_min=50):

    slide = openslide.OpenSlide(wsi_path)
    # level = level[0] # NO idea why this keeps happening
    print("Level dimenstions are", slide.level_dimensions)
...
def run(args):
    ...
    tissue_mask = getTissueMask(args.wsi_path, args.level, args.RGB_min)
